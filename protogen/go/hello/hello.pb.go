...
type HelloRequest struct {
	...
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"` // add mask for request
}
...
type HelloResponse struct {
	...
	Greeting string `protobuf:"bytes,1,opt,name=greeting,proto3" json:"greeting,omitempty"` // add mask for response
}
...
var file_proto_hello_hello_proto_rawDesc = []byte{
	...
	0x67, 0x32, 0x92, 0x02, 0x0a, 0x0c, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x6f, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x3e, 0x0a, 0x0d, 0x53,
	...
	0x61, 0x79, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x54, 0x6f, 0x45, 0x76, 0x65, 0x72, 0x79, 0x6f, 0x6e,
	...
	0x69, 0x6f, 0x6e, 0x75, 0x73, 0x12, 0x13, 0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x2e, 0x48, 0x65,
	...
	0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x53, 0x74, 0x30, 0x30, 0x67, 0x6e, 0x61, 0x2f, 0x6d, 0x79, 0x2d,
...
var file_proto_hello_hello_proto_depIdxs = []int32{
	...
	0, // 3: hello.HelloService.SayHelloContionus:input_type -> hello.HelloRequest
	...
	1, // 7: hello.HelloService.SayHelloContionus:output_type -> hello.HelloResponse
